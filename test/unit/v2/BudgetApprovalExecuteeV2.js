...
describe('BudgetApprovalExecuteeV2.sol - test/unit/v2/BudgetApprovalExecuteeV2.js', async function () {
  let deployer, team, budgetApproval, unknown;
  let executee, weth;
  beforeEach(async function () {
    [deployer, team, budgetApproval, unknown] = await ethers.getSigners();
    executee = await (await smock.mock('BudgetApprovalExecuteeV2', deployer)).deploy();
