...
describe('TransferERC721BudgetApprovalV2.sol - test/unit/v2/TransferERC721BudgetApprovalV2.js', async function () {
  ...
  beforeEach(async function () {
    ...
    TransferERC721BudgetApproval = await ethers.getContractFactory('TransferERC721BudgetApprovalV2', { signer: executeeAsSigner });
  ...
  describe('initialize()', async function () {
    it('init with params with the least setting successfully', async () => {
      ...
      const transferErc721BA = await ethers.getContractAt('TransferERC721BudgetApprovalV2', contract.address);
  ...
  describe('executeParams()', async function () {
    ...
    beforeEach(async function () {
      const contract = await ERC1967Proxy.deploy(
        transferErc721BAImpl.address,
        TransferERC721BudgetApproval.interface.encodeFunctionData('initialize', initializeParser()));
      transferErc721BA = await ethers.getContractAt('TransferERC721BudgetApprovalV2', contract.address);
    });
