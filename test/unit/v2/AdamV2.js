...
describe('AdamV2.sol - test/unit/v2/AdamV2.js', function () {
  ...
  beforeEach(async function () {
    ...
    Adam = await ethers.getContractFactory('AdamV2', { signer: deployer });
  ...
  describe('createDao()', async function () {
    ...
    beforeEach(async function () {
      daoForCreatrDao = await (await ethers.getContractFactory('DaoV2')).deploy();
