...
describe('TransferERC20BudgetApprovalV2.sol - test/unit/v2/TransferERC20BudgetApprovalV2.js', async function () {
  ...
  beforeEach(async function () {
    ...
    TransferERC20BudgetApproval = await ethers.getContractFactory('TransferERC20BudgetApprovalV2', { signer: executeeAsSigner });
  ...
  describe('initialize()', async function () {
    it('init with params with the least setting successfully', async () => {
      ...
      const transferErc20BA = await ethers.getContractAt('TransferERC20BudgetApprovalV2', contract.address);
  ...
  describe('executeParams()', async function () {
    ...
    beforeEach(async function () {
      const contract = await ERC1967Proxy.deploy(
        transferErc20BAImpl.address,
        TransferERC20BudgetApproval.interface.encodeFunctionData('initialize', initializeParser()));
      transferErc20BA = await ethers.getContractAt('TransferERC20BudgetApprovalV2', contract.address);
    });
