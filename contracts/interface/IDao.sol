...
interface IDao {
    ...
    function balanceOf(address member, uint256 token)
        external
        view
        returns (uint256);
    ...
    function tokenId(address contractAddress) external view returns (uint256);

    function tokenTotalSupply(uint256 tokenId) external view returns (uint256);
