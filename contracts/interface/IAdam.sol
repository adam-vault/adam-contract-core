...
interface IAdam {
    ...
    function setLiquidPoolImplementation(address _liquidPoolImplementation)
        external;

    function setMemberTokenImplementation(address _memberTokenImplementation)
        external;
