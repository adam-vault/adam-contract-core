...
interface ITransferERC20BudgetApproval {
    ...
    function decodeInitializeData(bytes memory _data)
        external
        pure
        returns (ICommonBudgetApproval.InitializeParams memory result);
