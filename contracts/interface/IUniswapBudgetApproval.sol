...
interface IUniswapBudgetApproval {
    ...
    function amountPercentage() external view returns (uint256);
    ...
    function checkVoteStatusCount(uint256 _transactionId)
        external
        view
        returns (uint256 approved, uint256 rejected);
