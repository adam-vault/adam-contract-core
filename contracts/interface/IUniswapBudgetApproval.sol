...
interface IUniswapBudgetApproval {
    ...
    event ExecuteUniswapTransaction(
        uint256 id,
        address tokenIn,
        address tokenOut,
        uint256 amountIn,
