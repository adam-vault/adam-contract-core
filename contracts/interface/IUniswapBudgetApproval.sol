...
interface IUniswapBudgetApproval {
    ...
    function decodeUniswapDataBeforeSwap(
        address to,
        bytes memory _data,
        uint256 amount
    )
