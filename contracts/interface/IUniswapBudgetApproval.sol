...
interface IUniswapBudgetApproval {
    ...
    function approverTeam() external view returns (uint256);
    ...
    function executorTeam() external view returns (uint256);
