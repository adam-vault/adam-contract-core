...
interface ISelfClaimERC20BudgetApproval {
    ...
    function claimedAddresses(address) external view returns (bool);
    ...
    function fixAmount() external view returns (uint256);
