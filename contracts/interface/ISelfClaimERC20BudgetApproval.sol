...
interface ISelfClaimERC20BudgetApproval {
    ...
    error ReceipientNotWhitelisted();
    ...
    function getMessageHash(address _entity) external pure returns (bytes32);
