...
import "../interface/IDaoV2.sol";

import "../interface/IMembership.sol";
import "../interface/ILiquidPool.sol";
import "../interface/IGovernFactory.sol";

contract AdamV2 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function createDao(CreateDaoParams memory params, bytes[] memory data) external returns (address) {
        ...
        IDaoV2(payable(address(_dao))).initialize(
            IDaoV2.InitializeParams(
                msg.sender,
                address(_membership),
                address(_liquidPool),
