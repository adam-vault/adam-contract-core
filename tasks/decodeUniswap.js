const knownSignatures = {
    ...
    '0x5023b4df':
        'exactOutputSingle((address tokenIn,address tokenOut,uint24 fee,address recipient,uint256 amountOut,uint256 amountInMaximum,uint160 sqrtPriceLimitX96))',
    ...
    '0xf3995c67':
        'selfPermit(address token,uint256 value,uint256 _deadline,uint8 _v,bytes32 _r,bytes32 _s)',
    '0xb858183f':
...
task('decode-uniswap', 'Decode Uniswap multicall data')
    ...
    .setAction(async ({ data }, hre) => {
        const iface = new hre.ethers.utils.Interface(
            Object.values(knownSignatures).map((sig) => `function ${sig}`),
        );
